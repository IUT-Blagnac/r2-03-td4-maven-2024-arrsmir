...
/* -----------------------------------------------------------------------------------
 * Hypothese :
 * Je n'ai pas ajoute de throwns exceptions au methodes car il etait specifiquement
 * precise dans l'enonce de " (ne pas rajouter de clause throws aux m�thodes)".
 * Je les ai cependant ajoute a la javadoc.
 * -----------------------------------------------------------------------------------
 */
...
public class Pile {
	 ...
	 * @param pfElement
	 * @throws Exception : la pile est pleine
	 */
	 ...
	 * @see 	Pile#estVide()
	 * @throws Exception : la pile est vide
	 */
	public void depiler()  {
		this.indiceSommet = this.indiceSommet - 1;
	}
